...
describe('Sftp component tests', () => {
  ...
  describe('uploadFile', () => {
    ...
    test('should upload a file when the directory does not exist in the SFTP server', async () => {
    ...
    test('should upload a file when the directory exists in the SFTP server', async () => {
      const filename = '2020-09-10.txt';
      const localPath = path.join(__dirname, '../../fixtures/original/echoes/');
  ...
  describe('uploadDir', () => {
    ...
    test('should upload a directory when the directory does not exists in the SFTP server', async () => {
  ...
  describe('createFile', () => {
    test('should create a file in the SFTP server with no content', async () => {
      const filename = '2020-09-10.txt';
      const remotePath = '/echoes/tmp';
    ...
    test('should create a file in the SFTP server with some content', async () => {
      const filename = '2020-09-10.txt';
      const remotePath = '/echoes/tmp';
  ...
  describe('appendToFile', () => {
    test('should throw when appending to remote file if the file does not exist in the SFTP server', async () => {
    ...
    test('should append to remote file if the file exists in the SFTP server', async () => {
      const filename = 'daily.csv';
      const remotePath = '/echoes/tmp';
      const localPath = path.join(__dirname, '../../fixtures/original/echoes/');
  ...
  describe('checkFileExists', () => {
    test('should return false when the file does not exist in the SFTP server', async () => {
      const filename = 'daily.csv';
      const remotePath = '/echoes/tmp';
    ...
    test('should return true when the file exist in the SFTP server', async () => {
      const filename = 'daily.csv';
      const remotePath = '/echoes/tmp';
